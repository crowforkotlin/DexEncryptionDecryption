...
public class Main {
     ...
     * 制作 Dex 命令
     */
    private static String DX_PATH = "C:\\Users\\CrowF\\AppData\\Local\\Android\\Sdk\\build-tools\\26.0.3\\dx.bat --dex --output ";

    /**
     * 制作 对齐 命令
     */
    private static String ZIPALIGN = "C:\\Users\\CrowF\\AppData\\Local\\Android\\Sdk\\build-tools\\26.0.3\\zipalign -v -p  4 ";

    /**
     * 制作 签名打包 命令
     */
    private static String APKSIGNER = "C:\\Users\\CrowF\\AppData\\Local\\Android\\Sdk\\build-tools\\26.0.3\\apksigner.bat sign --ks ";
    ...
    public static void makeDecodeDex() throws IOException, InterruptedException {
        ...
        System.out.println(classesJar.getAbsolutePath());
        System.out.println(classesDex.getAbsolutePath());
//       Windows 执行
        String path = "cmd /c C:\\Users\\CrowF\\AppData\\Local\\Android\\Sdk\\build-tools\\26.0.3\\dx.bat --dex --output " + classesDex.getAbsolutePath() + " " + classesJar.getAbsolutePath();
...
//        AES.init(AES.DEFAULT_PWD);
    ...
    private static void zipalign() throws IOException, InterruptedException {
        ...
        //Windows 执行
        Process process = Runtime.getRuntime().exec("cmd /c C:\\Users\\CrowF\\AppData\\Local\\Android\\Sdk\\build-tools\\26.0.3\\zipalign -v -p  4 " + unSignedApk.getAbsolutePath());
        //MAC 执行
...
//        System.out.println(process.waitFor() == 0 ? "zipalign成功" : "zipalign失败");
    ...
    public static void jksToApk() throws IOException, InterruptedException {
        ...
        File alignedApk = new File("app/build/outputs/apk/debug/app-unsigned.apk");
        ...
        //Windows 执行
        String path = "cmd /c C:\\Users\\CrowF\\AppData\\Local\\Android\\Sdk\\build-tools\\26.0.3\\apksigner.bat sign --ks " + jks.getAbsolutePath()
                + " --ks-key-alias yangkun --ks-pass pass:123123 --key-pass pass:123123 --out " + signedApk.getAbsolutePath() + " " + alignedApk.getAbsolutePath();
        System.out.println(path);
        Process process = Runtime.getRuntime().exec(path);
        //MAC 执行
